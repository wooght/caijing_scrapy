...
def api():
    if not rds.hexists('articles_nums', 'topics'):
        run()
    str = "[" + rds.hmget('articles_nums', 'topics')[0].decode('utf8'), ',', rds.hmget('articles_nums', 'news')[
        0].decode('utf8') + "]"
    return str
...
if __name__ == '__main__':
    ...
    print("[" + rds.hmget('articles_nums', 'topics')[0].decode('utf8'), ',',
          rds.hmget('articles_nums', 'news')[0].decode('utf8') + "]")
