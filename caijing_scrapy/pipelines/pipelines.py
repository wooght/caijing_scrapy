    ...
    def process_item(self, item, spider):
        ...
        # 股票代码
            ...
            if (spider.name in ['codes', 'newcodes']):
                ...
                u = T.listed_company.update().where(T.listed_company.c.codeid == item['codeid']).values(
        ...
        # 公司公告
            ...
            s = T.select([T.company_notice]).where(T.company_notice.c.title == item['title']).where(
